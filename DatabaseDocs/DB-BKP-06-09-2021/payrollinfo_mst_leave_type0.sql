...
CREATE TABLE `mst_leave_type` (
  ...
  `is_leave_without_pay` varchar(1) NOT NULL,
  `carry_forward` varchar(1) NOT NULL,
...
INSERT INTO `mst_leave_type` VALUES ('CL','Casual Leave','Y','N'),('EL','Earn Leave','Y','Y'),('SL','Sick Leave','Y','N');
