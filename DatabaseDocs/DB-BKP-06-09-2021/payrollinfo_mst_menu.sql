...
CREATE TABLE `mst_menu` (
  ...
  `menu_icon` varchar(15) DEFAULT NULL,
  `is_divider` varchar(1) DEFAULT NULL,
  PRIMARY KEY (`menu_id`)
...
INSERT INTO `mst_menu` VALUES (1,'master','Master','HomeIcon','N'),(2,'transaction','Transaction','ReceiptIcon','Y'),(3,'reports','Reports','ReportIcon','Y');
...
-- Dump completed on 2021-09-07 12:51:01
