...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `ManagePaySheet` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ManagePaySheet`(p_month INT,p_year INT
			,OUT p_return_message VARCHAR(500))
proc_label:BEGIN
	DECLARE no_earn_types INT;
    DECLARE no_ded_types INT;
    DECLARE p_return_code INT;
	...
	SET no_earn_types=
    (SELECT count(medc.earn_ded_type) AS no_earntypes
    FROM payrollinfo.mst_earn_ded_components medc
	WHERE medc.earn_ded_type='E');
    
    SET no_ded_types=
    (SELECT count(medc.earn_ded_type) AS no_dedtypes
    FROM payrollinfo.mst_earn_ded_components medc
	WHERE medc.earn_ded_type='D');
    
    DELETE FROM trn_pay_sheet_field_codes;
    INSERT INTO trn_pay_sheet_field_codes(ps_month,ps_year,no_earn_field_types,no_ded_field_types)
    VALUES(p_month,p_year,no_earn_types,no_ded_types);
    
    SELECT * FROM trn_pay_sheet_field_codes;
    COMMIT;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
